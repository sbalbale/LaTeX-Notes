...
\usepackage[margin=0.20in, top=0.18in, bottom=0.18in]{geometry}
...
% --- Squeezing Space ---
\linespread{0.58}
\titlespacing*{\section}{0pt}{1.2pt}{0.5pt}
\titlespacing*{\subsection}{0pt}{0.8pt}{0.3pt}
% -----------------------
\date{}
\begin{document}
\normalsize \textbf{ENGR 232 Final Exam Notesheet} \hfill Sean Balbale \hfill Spring 2026 \vspace{0.08cm}
\hrule
\vspace{0.06cm}
\begin{multicols*}{2}
