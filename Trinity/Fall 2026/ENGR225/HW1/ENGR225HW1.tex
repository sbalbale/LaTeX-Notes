...
\textbf{Given / Find:} Flagpole $OA$ ($O$ at the base, $A$ at the top) is connected by cables $AB$ and $AC$ anchored to a wall. Using the dimensions shown, find the angles $\theta$ (between $OA$ and $AB$) and $\phi$ (between $OA$ and $AC$).
